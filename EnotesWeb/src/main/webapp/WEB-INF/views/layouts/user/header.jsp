...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
	<a class="navbar-brand" href='<c:url value="/"/>'><i
		class="fa fa-book" aria-hidden="true"></i> ENotes </a>
			...
			<c:when test="${sessionScope.user != null}">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item"><a class="nav-link"
						href='<c:url value="/newNote"/>'><i class="fa fa-plus-circle"
							aria-hidden="true"></i> Add Notes </a></li>

					<li class="nav-item"><a class="nav-link "
						href='<c:url value="/notes"/>'><i class="fa fa-address-book-o"
